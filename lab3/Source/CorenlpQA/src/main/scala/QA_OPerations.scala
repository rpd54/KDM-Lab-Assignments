...
object QA_OPerations {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val processedData = "C:\\Users\\USER\\Documents\\QA_TFIDFandW2V\\data\\Article.txt.txt"
    val sContext = new SparkContext(configurationSpark)
    val outputFile = "C:\\Users\\USER\\Documents\\QA_TFIDFandW2V\\data\\output.txt"

    val fileData = ReadWriteOperation.ReadFile("data\\input.txt",StandardCharsets.UTF_8)
